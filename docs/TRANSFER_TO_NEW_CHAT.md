...
## Текущий пакет
- Версия архива: **v0.1.53**
- Версия в `VERSION`: **0.1.53**
- Версия backend (`APP_VERSION`): **0.1.53**
- Версия Docker build arg: **0.1.53**
...
- `docs/releases/0.1.53/RELEASE_NOTES.md` — заметки по текущему релизу
...
> Базовый архив: v0.1.53.
> Смотри `docs/TRANSFER_TO_NEW_CHAT.md` и `docs/releases/0.1.53/RELEASE_NOTES.md`.
> Текущий фокус: проверить живой парсинг/отображение профиля подписки 3x-ui и корректную версию 0.1.53 в runtime/UI, затем вернуться к функциональному monitoring/Ansible-контуру.
