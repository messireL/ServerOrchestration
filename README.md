...
- **v0.1.44** — стабилизация persisted probe details для 3x-ui/SSL и возврат к функциональному контуру;
...
Current next build after v0.1.44 focuses on persisted 3x-ui subscription details, SSL certificate metadata, and richer probe history output for monitoring.